...
public interface VirtualServer<T> {
     ...
     */
    void moveTotem(String nickname, char offerTileId) throws Exception;

    /*
     The client wants to take a card from the board.
     The server validates: turn, phase, food, card available.
     */
    void addCard(String nickname, int cardId) throws Exception;
     ...
     */
    void addExtraCard(String nickname, int cardId) throws Exception;
